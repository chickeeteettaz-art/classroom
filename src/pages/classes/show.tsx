...
const ClassesShow = () => {
    ...
    const placeHolderUrl = `https://placehold.co/600x400?text=${encodeURIComponent(teacherInitials)}`;
            ...
            <Card className={'class-details'}>
                <div className={'details-card'}>
                    <div className={'details-header'}>
                        ...
                        <div>
                            <Badge variant={'outline'}><span>{capacity}</span></Badge>
                    ...
                    <div className={'details-grid'}>
                        <div className={'instructor'}>
                            <p>Instructor</p>
                            <div>
                                <img src={ placeHolderUrl} alt={'Teacher'}/>
